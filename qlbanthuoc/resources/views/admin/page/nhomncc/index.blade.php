            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="table-responsive text-center">
                        <table class="table table-borderless" id="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Chiết khấu nhập</th>
                                    <th class="text-center">Chiết khấu xuất</th>
                        ...
                        <input type="hidden" value="deletenhomncc" id="xoa"/>
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
