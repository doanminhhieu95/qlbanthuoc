            ...
            <div class="col-xs-12">
                <div class="form-group row add">
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-5">
                                <input type="text" class="form-control" id="sohieu" name="sohieu" placeholder="Số hiệu">
                ...
                <div class="box">
                    ...
                    <div class="table-responsive text-center">
                        ...
                        <input type="hidden" value="addbaoquan" id="them" />
                        <input type="hidden" value="editbaoquan" id="sua" />
                        <input type="hidden" value="deletebaoquan" id="xoa" />
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="sohieu">Số hiệu:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="s" disabled>
                        </div>
                    </div>
                    <div class="form-group">
