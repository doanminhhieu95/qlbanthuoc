                    ...
                    <div class="table-responsive text-center">
                        <table class="table table-borderless" id="table">
                            ...
                            <tr class="item{{$item->id}}">
                                ...
                                <td>{{$item->ghichu}}</td>
                                <td>
                                    <a href="nhasanxuat/{{$item->id}}/edit">
                                        <button class="btn btn-info btn-sm" data-id="{{$item->id}}" data-name="{{$item->name}}">
                        ...
                        <input type="hidden" value="deletenhasanxuat" id="xoa"/>
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
